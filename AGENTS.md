...
Este repositório usa um harness operacional para orientar agentes de IA, Copilot e OpenCode.

Antes de alterar código, qualquer agente deve ler este arquivo e seguir as referências abaixo:

...
| -- | --------- | ------------------- | -------------- |
| P1-1 | Tenant/application inativos nao bloqueiam fluxos autenticados | `ApiKeyAuthenticationMiddleware` nao verifica `TenantStatus`/`ApplicationStatus` | Slice 6-A |
